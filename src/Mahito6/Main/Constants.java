...
public class Constants{
    ...
    public static final int divideImageGarbageThreshold = 100; //分割したときの点の数がこれ以下ならゴミとして除去
    ...
    public static double unitInch = 25.4;
	...
	public static final int expandOffset = 1;
	public static final int Nameraka = 0;
}