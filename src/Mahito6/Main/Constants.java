...
public class Constants{
    ...
    public static int edgeWidth = 7;   //エッジの太さ(この太さで２値画像から辺を消す)waku:12 piece:6
	public static final int MethodWidth = 6;
    public static int lrAddition = 50; //検出して切断したエッジを少しだけ伸ばす waku:50 piece:15
    ...
    public static final int imagePositionOffset = 300;
