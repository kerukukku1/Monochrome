...
public class Constants{
    ...
    public static int lrAddition = 15; //検出して切断したエッジを少しだけ伸ばす waku:50 piece:15
    public static final int actQueueSize = 5000000;
    public static final int coordQueueSize = 150000;
